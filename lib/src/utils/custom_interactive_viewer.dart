...
class CustomInteractiveViewer extends StatefulWidget {
  ...
  @override
  State<CustomInteractiveViewer> createState() => _InteractiveViewerState();
}

class _InteractiveViewerState extends State<CustomInteractiveViewer>
  ...
  void _receivedPointerSignal(PointerSignalEvent event) {
    if (event is PointerScrollEvent) {
      ...
      final Offset translation = Offset(
        -(event.scrollDelta.dx * widget.scrollOffsetRatio),
        -(event.scrollDelta.dy * widget.scrollOffsetRatio),
      );
      _transformationController!.value = _matrixTranslate(
        _transformationController!.value,
        translation,
