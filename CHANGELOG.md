...
## 1.4.6
- Add getTotalPageSize
- Make getPage nullable
...
## 1.4.2
- Make pdfPage optional instead of late

## 1.4.1
- Make pdfPage optional instead of late

## 1.4.0
- Add `realSizeOverlayUpdateBufferDuration`, `fullPurgeDistThreshold` and `partialRemovalDistThreshold` to help smooth out web scrolling

## 1.3.9
- Add `scrollOffsetRatio` to help smooth out web scrolling
...
- Fix [#66](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/66) await page.render() crashed on web
...
- Fix Rendering breakage on recent Flutter ([#84](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/84))
...
- FIXED: [#56](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/56) Null check operator used on a null value

## 1.0.23

- Add PdfViewerController.goToPointInPage/setZoomRatio ([#71](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/71)/[#72](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/72))
- Document updates
...
- PdfViewerParams introduces scrollDirection to support horizontal scroll ([#69](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/69)).
...
- Add workaround for recent Flutter Web breaking change ([#60](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/60)).

## 1.0.17

- Additional null check on updateTex (Android); possible fix for [#59](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/59) and [#61](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/61).
...
- Merge PR [#55](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/55) Add flutter_lints
...
- Merged PR [#54](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/54) "device_info replace by device_info_plus" by lsaudon

## 1.0.12

- Fix [#50](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/50) Hot Reload throws error on Change Notifier

## 1.0.11

- Implements page memory purging ([#44](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/44))
- Unified code for iOS/macOS
- Better error handling code for iOS/macOS ([#44](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/44))

## 1.0.10

- More null-check codes for possible runtime exceptions on dispose ([#42](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/42)).
...
- Additional fix for [#35](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/35) web - renders blank, with no console error

## 1.0.5

- Fix [#35](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/35) web - renders blank, with no console error
...
- BREAKING CHANGE: pdf_render_scroll_widget2 overwrites pdf_render_scroll_widget.
...
- Introducing PdfViewer that supports interactive pinch-zoom ([#5](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/5)); not yet complete but things just work well.

## 0.65.0

- Fixes PDF page rotation issue on iOS ([#18](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/18))
- Fixes Y-axis flipping issue on iOS ([#9](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/9))
...
- Introducing PdfDocumentLoader.onError to handle document open error ([#17](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/17) by Sp4Rx).
...
- Introduces pdf_render_scroll_widgets2.dart. The classes in pdf_render_scroll_widgets.dart are deprecated now.

## 0.57.2

- Update pubspec.yaml not to be shown as WEB compatible on pub.dev ([#11](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/11)).

## 0.57.1

- Update comments ([#6](https://github.com/espresso3389/flutter_pdf_render_scroll/issues/6)).
